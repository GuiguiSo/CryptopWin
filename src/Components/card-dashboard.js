                            ...
                            <div className="row" >
                                ...
                                <div class="col-sm-7">
                                    <div class="card-body text-light center">
                                        <h1 class="card-title">Crypto.com</h1>
                                        <h2 class="card-text">Inscrivez vous et profité de 25$ à dépenser</h2>
                                        <div className="mt-2">
                                            <Link to="/viewcard" >
                                                <button className="btn-primary btn-lg btn-block">BONUS</button>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
